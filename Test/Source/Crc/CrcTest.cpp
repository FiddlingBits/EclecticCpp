...
#include "Test/Source/Crc/CrcTest.h"
...
/*** CRC8 ***/
/* Calculate Full */
TEST_F(Crc8Test, CalculateFull)
{
    /* Test */
    for(Eclectic::Crc8Configuration::Algorithm Algorithm : Algorithms)
    {
        /* CRC8 */
        const Eclectic::Crc8Configuration Configuration {Eclectic::Crc8Configuration::get(Algorithm)};
        Eclectic::Crc8 crc8(Configuration);

        /* Calculate Full (Without Lookup Table) */
        EXPECT_EQ(crc8.Configuration.check, crc8.calculate(Data)) << std::format("{}: 0x{:02X} != 0x{:02X}", crc8.Configuration.name, crc8.Configuration.check, crc8.calculate(Data));

        /* Calculate Full (With Lookup Table) */
        crc8.generateLookupTable();
        EXPECT_EQ(crc8.Configuration.check, crc8.calculate(Data)) << std::format("{}: 0x{:02X} != 0x{:02X}", crc8.Configuration.name, crc8.Configuration.check, crc8.calculate(Data));
    }
}

/* Calculate Partial */
TEST_F(Crc8Test, CalculatePartial)
{
    std::uint8_t crc;
    ...
    for(Eclectic::Crc8Configuration::Algorithm Algorithm : Algorithms)
    {
        ...
        /* Calculate Partial (Without Lookup Table) */
        crc = crc8.Configuration.initial;
        for(int i = 0; i < Data.size(); i++)
            crc = crc8.calculate(Data[i], crc, i == (Data.size() - 1));
        EXPECT_EQ(crc8.Configuration.check, crc) << std::format("{}: 0x{:02X} != 0x{:02X}", crc8.Configuration.name, crc8.Configuration.check, crc8.calculate(Data));

        /* Calculate Partial (With Lookup Table) */
        crc8.generateLookupTable();
        crc = crc8.Configuration.initial;
        for(int i = 0; i < Data.size(); i++)
            crc = crc8.calculate(Data[i], crc, i == (Data.size() - 1));
...
/* To String */
TEST_F(Crc8Test, ToString)
{
    /* Test Data Structure */
    struct Crc8ToStringTestData
    {
        public:
            /* Variable */
            const Eclectic::Crc8Configuration::Algorithm Algorithm;
            const std::string Header;
            const std::string LookupTable;
    };

    /* Test Data */
    const std::vector<Crc8ToStringTestData> TestData =
    {
        {
    ...
    /* Test */
    for(const Crc8ToStringTestData& Data : TestData)
    {
        /* CRC8 */
        const Eclectic::Crc8Configuration Configuration {Eclectic::Crc8Configuration::get(Data.Algorithm)};
        Eclectic::Crc8 crc8(Configuration);

        /* To String (Without Lookup Table) */
        EXPECT_EQ(Data.Header, crc8.toString()) << crc8.Configuration.name;

        /* To String (With Lookup Table) */
        crc8.generateLookupTable();
        EXPECT_EQ(Data.Header + Data.LookupTable, crc8.toString()) << crc8.Configuration.name;
    }
}

/*** CRC16 ***/
/* Calculate Full */
TEST_F(Crc16Test, CalculateFull)
{
    /* Test */
    for(Eclectic::Crc16Configuration::Algorithm Algorithm : Algorithms)
    {
        /* CRC16 */
        const Eclectic::Crc16Configuration Configuration {Eclectic::Crc16Configuration::get(Algorithm)};
        Eclectic::Crc16 crc16(Configuration);

        /* Calculate Full (Without Lookup Table) */
        EXPECT_EQ(crc16.Configuration.check, crc16.calculate(Data)) << std::format("{}: 0x{:04X} != 0x{:04X}", crc16.Configuration.name, crc16.Configuration.check, crc16.calculate(Data));

        /* Calculate Full (With Lookup Table) */
        crc16.generateLookupTable();
        EXPECT_EQ(crc16.Configuration.check, crc16.calculate(Data)) << std::format("{}: 0x{:04X} != 0x{:04X}", crc16.Configuration.name, crc16.Configuration.check, crc16.calculate(Data));
    }
}

/* Calculate Partial */
TEST_F(Crc16Test, CalculatePartial)
{
    std::uint16_t crc;
    ...
    for(Eclectic::Crc16Configuration::Algorithm Algorithm : Algorithms)
    {
        ...
        /* Calculate Partial (Without Lookup Table) */
        crc = crc16.Configuration.initial;
        for(int i = 0; i < Data.size(); i++)
            crc = crc16.calculate(Data[i], crc, i == 0, i == (Data.size() - 1));
        EXPECT_EQ(crc16.Configuration.check, crc) << std::format("{}: 0x{:04X} != 0x{:04X}", crc16.Configuration.name, crc16.Configuration.check, crc16.calculate(Data));
...
/* To String */
TEST_F(Crc16Test, ToString)
{
    /* Test Data Structure */
    struct Crc16ToStringTestData
    {
        public:
            /* Variable */
            const Eclectic::Crc16Configuration::Algorithm Algorithm;
            const std::string Header;
            const std::string LookupTable;
    };

    const std::vector<Crc16ToStringTestData> TestData =
    {
        {
    ...
    /* Test */
    for(const Crc16ToStringTestData& Data : TestData)
    {
        /* CRC16 */
        const Eclectic::Crc16Configuration Configuration {Eclectic::Crc16Configuration::get(Data.Algorithm)};
        Eclectic::Crc16 crc16(Configuration);

        /* To String (Without Lookup Table) */
        EXPECT_EQ(Data.Header, crc16.toString()) << crc16.Configuration.name;

        /* To String (With Lookup Table) */
        crc16.generateLookupTable();
        EXPECT_EQ(Data.Header + Data.LookupTable, crc16.toString()) << crc16.Configuration.name;
    }
}

/*** CRC32 ***/
/* Calculate Full */
TEST_F(Crc32Test, CalculateFull)
{
    /* Test */
    for(Eclectic::Crc32Configuration::Algorithm Algorithm : Algorithms)
    {
        /* CRC32 */
        const Eclectic::Crc32Configuration Configuration {Eclectic::Crc32Configuration::get(Algorithm)};
        Eclectic::Crc32 crc32(Configuration);

        /* Calculate Full (Without Lookup Table) */
        EXPECT_EQ(crc32.Configuration.check, crc32.calculate(Data)) << std::format("{}: 0x{:08X} != 0x{:08X}", crc32.Configuration.name, crc32.Configuration.check, crc32.calculate(Data));

        /* Calculate Full (With Lookup Table) */
        crc32.generateLookupTable();
        EXPECT_EQ(crc32.Configuration.check, crc32.calculate(Data)) << std::format("{}: 0x{:08X} != 0x{:08X}", crc32.Configuration.name, crc32.Configuration.check, crc32.calculate(Data));
    }
}

/* Calculate Partial */
TEST_F(Crc32Test, CalculatePartial)
{
    std::uint32_t crc;
    ...
    for(Eclectic::Crc32Configuration::Algorithm Algorithm : Algorithms)
    {
        ...
        /* Calculate Partial (Without Lookup Table) */
        crc = crc32.Configuration.initial;
        for(int i = 0; i < Data.size(); i++)
            crc = crc32.calculate(Data[i], crc, i == 0, i == (Data.size() - 1));
        EXPECT_EQ(crc32.Configuration.check, crc) << std::format("{}: 0x{:08X} != 0x{:08X}", crc32.Configuration.name, crc32.Configuration.check, crc32.calculate(Data));
...
/* To String */
TEST_F(Crc32Test, ToString)
{
    /* Test Data Structure */
    struct Crc32ToStringTestData
    {
        public:
            /* Variable */
                "  0x40005999, 0xC1411832, 0xC3C39B64, 0x4282DACF, 0xC6C69DC8, 0x4787DC63, 0x45055F35, 0xC4441E9E, 0xCCCC9090, 0x4D8DD13B, 0x4F0F526D, 0xCE4E13C6, 0x4A0A54C1, 0xCB4B156A, 0xC9C9963C, 0x4888D797,\n"
                "  0xD8D88A20, 0x5999CB8B, 0x5B1B48DD, 0xDA5A0976, 0x5E1E4E71, 0xDF5F0FDA, 0xDDDD8C8C, 0x5C9CCD27, 0x54144329, 0xD5550282, 0xD7D781D4, 0x5696C07F, 0xD2D28778, 0x5393C6D3, 0x51114585, 0xD050042E,\n"
                "  0xF0F0BF40, 0x71B1FEEB, 0x73337DBD, 0xF2723C16, 0x76367B11, 0xF7773ABA, 0xF5F5B9EC, 0x74B4F847, 0x7C3C7649, 0xFD7D37E2, 0xFFFFB4B4, 0x7EBEF51F, 0xFAFAB218, 0x7BBBF3B3, 0x793970E5, 0xF878314E,\n"
                "  0x68286CF9, 0xE9692D52, 0xEBEBAE04, 0x6AAAEFAF, 0xEEEEA8A8, 0x6FAFE903, 0x6D2D6A55, 0xEC6C2BFE, 0xE4E4A5F0, 0x65A5E45B, 0x6727670D, 0xE66626A6, 0x622261A1, 0xE363200A, 0xE1E1A35C, 0x60A0E2F7,\n"
                "  0xA0A0D580, 0x21E1942B, 0x2363177D, 0xA22256D6, 0x266611D1, 0xA727507A, 0xA5A5D32C, 0x24E49287, 0x2C6C1C89, 0xAD2D5D22, 0xAFAFDE74, 0x2EEE9FDF, 0xAAAAD8D8, 0x2BEB9973, 0x29691A25, 0xA8285B8E,\n"
                "  0x38780639, 0xB9394792, 0xBBBBC4C4, 0x3AFA856F, 0xBEBEC268, 0x3FFF83C3, 0x3D7D0095, 0xBC3C413E, 0xB4B4CF30, 0x35F58E9B, 0x37770DCD, 0xB6364C66, 0x32720B61, 0xB3334ACA, 0xB1B1C99C, 0x30F08837,\n"
                "  0x10503359, 0x911172F2, 0x9393F1A4, 0x12D2B00F, 0x9696F708, 0x17D7B6A3, 0x155535F5, 0x9414745E, 0x9C9CFA50, 0x1DDDBBFB, 0x1F5F38AD, 0x9E1E7906, 0x1A5A3E01, 0x9B1B7FAA, 0x9999FCFC, 0x18D8BD57,\n"
                "  0x8888E0E0, 0x09C9A14B, 0x0B4B221D, 0x8A0A63B6, 0x0E4E24B1, 0x8F0F651A, 0x8D8DE64C, 0x0CCCA7E7, 0x044429E9, 0x85056842, 0x8787EB14, 0x06C6AABF, 0x8282EDB8, 0x03C3AC13, 0x01412F45, 0x80006EEE\n"
            }
        },
    };

    /* Test */
    for(const Crc32ToStringTestData& Data : TestData)
    {
        /* CRC32 */
        const Eclectic::Crc32Configuration Configuration {Eclectic::Crc32Configuration::get(Data.Algorithm)};
        Eclectic::Crc32 crc32(Configuration);

        /* To String (Without Lookup Table) */
        EXPECT_EQ(Data.Header, crc32.toString()) << crc32.Configuration.name;

        /* To String (With Lookup Table) */
        crc32.generateLookupTable();
        EXPECT_EQ(Data.Header + Data.LookupTable, crc32.toString()) << crc32.Configuration.name;
    }
}
